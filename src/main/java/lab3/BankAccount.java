...
public class BankAccount {
    ...
    // arraylist to hold the transactions as pairs of integers
    // -> Pair(int amount, int account number)
    private List<Pair<Integer, Integer>> transactionHistory
    ...
    /**
     * Create a new account with a given account ID and balance 0.
     * If ID is already associated with an account or ID negative,
     *      throw an exception.
     *
     ...
     * If ID is already associated with an account or ID negative
     * or balance negative throw an exception.
     *
